...
export default function signUpPage() {
    ...
    <Container maxwidth="sm"> 
        ...
        borderRadius:0
            ...
            <Toolbar>
                <Typography variant="h6" sx={{flexGrow:1, cursor:'pointer'}}>Smart Flashcards</Typography>
                <Button color="inherit">
                    <Link href="/sign-in" passHref color='inherit'sx={{textDecoration:'none'}}>Log In</Link> 
                </Button>
                <Button color="inherit">
